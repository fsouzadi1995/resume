...
\resumeSubHeadingListStart
	\resumeSubheading
		...
		{Ssr. FullStack Developer @ Farmacity Point Of Sale team}{Nov 2020 - Present}
			\resumeItemListStart
				\resumeItem{Backend}
...
\resumeSubHeadingListStart	
	\resumeItem{C Sharp} 
	{ASP.NET, ADO.NET, LINQ, Entity Framework, .NET MVC, RESTful Web Services, SOA architecture}
...
\resumeSubHeadingListStart
  ...
  \resumeItem{.NET Runtime Frameworks}
